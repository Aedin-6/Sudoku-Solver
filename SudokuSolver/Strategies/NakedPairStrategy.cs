...
namespace SudokuSolver.Strategies
{
    class NakedPairStrategy : ISudokuStrategy
    {
        ...
        public int[,] Solve(int[,] sudokuBoard)
        {
            for (int row = 0; row < sudokuBoard.GetLength(0); row++)
            {
                ...
                for (int col = 0; col < sudokuBoard.GetLength(0); col++)
                {
                    ...
                    EliminatedNakedPairFromOtherInRow(sudokuBoard, row, col);
                    EliminatedNakedPairFromOtherInCol(sudokuBoard, row, col);
                    EliminatedNakedPairFromOtherInBlock(sudokuBoard, row, col);
        ...
        private void EliminatedNakedPairFromOtherInRow(int[,] sudokuBoard, int givenRow, int givenCol)
        {
        ...
        private void EliminatedNakedPairFromOtherInCol(int[,] sudokuBoard, int givenRow, int givenCol)
        {
        ...
        private void EliminatedNakedPairFromOtherInBlock(int[,] sudokuBoard, int givenRow, int givenCol)
        {
