...
namespace SudokuSolver.test.unit
{
    ...
    {
        private readonly ISudokuStrategy _simpleMarkupSudokuStrat = new SimpleMarkUpStrategy(new SudokuMapper());
        ...
        public void SimpleStrategyShouldSolveAlmostCompletedSudokuForTopLeftCell()
        {
            ...
            var solvedSudokuBoard = _simpleMarkupSudokuStrat.Solve(sudokuBoard);
